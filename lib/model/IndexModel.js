...
class PredictIndexModelFactory {
  ...
  constructor(factory) {
    ...
    this._busCountIndexModel = this.modelFunction('busCount',
      modelInitializer(async () => factory.getBusCountIndexModel()));

    this._busSpeedIndexModel = this.modelFunction('busSpeed',
      modelInitializer(async () => factory.getBusSpeedIndexModel()));

    this._overallSpeedIndexModel = this.modelFunction('overallSpeed',
      modelInitializer(async () => factory.getOverallSpeedIndexModel()));

    this._pilgrimCountIndexModel = this.modelFunction('pilgrimCount',
      modelInitializer(async () => factory.getPilgrimCountIndexModel()));
  }

  modelFunction(name, initializer) {
    return async () => {
