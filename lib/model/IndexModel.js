...
class BaseIndexModel {
  ...
  getPredictIndexData() {
    ...
    return predictIndexModel.getIndexData(0, 86400 / this._timeunit);
  }
...
const indexModelFactory = new IndexModel();

export default indexModelFactory;
