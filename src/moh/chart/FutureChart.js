...
export default class FutureChart extends XYAxisChart {
  ...
  setSelectedTimestamp(value) {
    ...
    if (value) {
      const from = new Date(value.getFullYear(), value.getMonth(), value.getDate(), value.getHours(), value.getMinutes(), value.getSeconds() - 5);
      const to = new Date(value.getFullYear(), value.getMonth(), value.getDate(), value.getHours(), value.getMinutes(), value.getSeconds() + 5);
