...
export default class Chart extends View
{
  metadata = {
    ...
    aggregations: {
      series: { type: "nju.chart.series.Series", singularName: "series" }
    }
  };
  ...
  _initLegend()
  {
    this.legendGroup = this.svg.append("g").classed("legend", true).style("opacity", 0);
  }
  ...
  prependLayer()
  {
    let layer = this.contentGroup.insert("g", ":first-child").classed("layer", true);
    return layer;
  }
  ...
  redrawOnce()
  {
    ...
    this._redrawTimeout = setTimeout(this.redraw.bind(this), 200);
  }
